...
public class DBManagerSQLite {
    ...
    //Hier kann ggf. die Vorbelegung ge�ndert werden, um eine andere Datenbank als Standard festzulegen
    ...
    public DBManagerSQLite() {
        ...
        //Treiber laden
        try{
            Class.forName("org.sqlite.JDBC");  //f�r ein anderes dateibasiertes Datenbanksystem m�sste hier der Treiber entsprechend ge�ndert werden
        ...
        try{
            verbindung = DriverManager.getConnection("jdbc:sqlite:" + dbName+".db");  //hier m�sste f�r ein anderes Datenbanksystem die URL angepasst werden
    ...
    public String[][] sqlAnfrageAusfuehren(String sqlAnfrage){
        ...
        try{
            ...
            //zun&auml;chst muss die Gr&ouml;�e der ben&ouml;tigten Zeilen und Spalten in der Reihung bestimmt werden.
    ...
    /**
     * führt die &uuml;bergebene SQL-Einf&uuml;ge-Anweisung aus
